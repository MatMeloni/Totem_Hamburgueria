...
import '/pages/pedidoenviado/pedidoenviado_widget.dart';
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 8.0, 0.0, 0.0),
                                                child: Text(
                                                  'Quantitade: ${listViewCartRecord.qtd.toString()}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PedidoenviadoWidget(),
                    ),
                  );
                },
                text: 'Enviar pedido',
